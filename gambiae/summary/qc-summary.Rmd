...
library(GOstats)
library(GSEABase)
mart = useMart("vb_gene_mart_1412")
gambiae = useMart(biomart="vb_gene_mart_1412", dataset="agambiae_eg_gene")
...
spermatheca_features = fs[features[[3]]]
